...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    /**
     * Creates new form listagemVIEW2
     */
    public listagemVIEW() {
        initComponents();
        listarProdutos();
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addComponent(btnConsultarVendas,
                                                        ...
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addComponent(jSeparator1, javax.swing.GroupLayout.PREFERRED_SIZE, 440,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnVenderActionPerformed
        // Pega o id digitado no campo de texto 'id_produto_venda'
        String idText = id_produto_venda.getText();

        // Verifica se o campo de ID não está vazio e se é um número válido
        if (idText.isEmpty()) {
        ...
        try {
            int id = Integer.parseInt(idText); // Converte o texto para inteiro

            ProdutosDAO dao = new ProdutosDAO();
            // Chama o método para vender o produto com o id informado
